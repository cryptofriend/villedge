...
export const VillageSocialIcons = ({ village, className = "" }: VillageSocialIconsProps) => {
  const hasSocialLinks = village.website_url || village.telegram_url || village.twitter_url || village.instagram_url || (village as any).facebook_url;
  ...
  return (
    <div className={`flex items-center gap-1.5 ${className}`}>
      ...
      {(village as any).facebook_url && (
        <a
          href={(village as any).facebook_url}
          target="_blank"
          rel="noopener noreferrer"
          className="p-1 rounded-md text-muted-foreground hover:text-foreground hover:bg-muted/50 transition-colors"
          title="Facebook"
