-- Update settings table policies to allow both admin accounts
...
WITH CHECK (
  auth.uid() = '9807c494-ba07-4438-9a89-07ac13334e78'::uuid 
  OR auth.uid() = 'b015441b-3bb4-4150-94e6-d8be048035bb'::uuid
);
...
-- Update notification_routes table policies to allow both admin accounts
